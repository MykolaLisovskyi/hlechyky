...
public sealed partial class Clicker
{
    ...
    [
        new("pot", "Горщик", 40, 25, 0),
        new("bowl", "Миска", 50, 32, 0),
        new("jug", "Глечик", 80, 55, 1_000),
        new("makitra", "Макітра", 120, 90, 10_000),
        new("dish", "Полумисок", 100, 80, 100_000),
        new("candle", "Свічник", 90, 72, 1_000_000),
        new("whistle", "Свищик-півник", 70, 60, 5_000_000),
        new("barrel", "Барило", 200, 170, 50_000_000),
        new("tile", "Кахля", 150, 125, 500_000_000),
        new("kumanets", "Куманець", 320, 300, 5_000_000_000),
        new("ram", "Баранець-свищик", 260, 245, 50_000_000_000),
        new("lion", "Лев-посудина", 500, 520, 1_000_000_000_000),
    ];
